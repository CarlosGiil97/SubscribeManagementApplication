  ...
  if(b.id=='Sector2_tribuna_media'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR2_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR2_tribuna_media[$i]+'_'+arrayJSfilasSECTOR2_tribuna_media[$i]+'_'+arrayJSasientosSECTOR2_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR3_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR3_tribuna_media[$i]+'_'+arrayJSfilasSECTOR3_tribuna_media[$i]+'_'+arrayJSasientosSECTOR3_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR4_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR4_tribuna_media[$i]+'_'+arrayJSfilasSECTOR4_tribuna_media[$i]+'_'+arrayJSasientosSECTOR4_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR5_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR5_tribuna_media[$i]+'_'+arrayJSfilasSECTOR5_tribuna_media[$i]+'_'+arrayJSasientosSECTOR5_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR6_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR6_tribuna_media[$i]+'_'+arrayJSfilasSECTOR6_tribuna_media[$i]+'_'+arrayJSasientosSECTOR6_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR7_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR7_tribuna_media[$i]+'_'+arrayJSfilasSECTOR7_tribuna_media[$i]+'_'+arrayJSasientosSECTOR7_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR9_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR9_tribuna_media[$i]+'_'+arrayJSfilasSECTOR9_tribuna_media[$i]+'_'+arrayJSasientosSECTOR9_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR10_tribuna_media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR10_tribuna_media[$i]+'_'+arrayJSfilasSECTOR10_tribuna_media[$i]+'_'+arrayJSasientosSECTOR10_tribuna_media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
