            ...
            <!-- style="margin-left: 15%; !important" -->
                ...
                <div class="card-body">
                   ...
                   <div id="mapa">
                          ...
                          <map name="image-map">
                      <area target="" alt="Tribuna_Alta" id="Tribuna_Alta" title="Tribuna_Alta" href="Tribuna_Alta.php" onMouseOver="placeImage1()" onmouseleave="saleraton()"  coords="149,101,1187,101,1172,60,160,60" shape="poly">
                      <area target="" alt="Tribuna_Media" id="Tribuna_Baja" title="Tribuna_Media" href="Tribuna_Media.php" onMouseOver="placeImage2()" onmouseleave="saleraton()"  coords="138,164,1196,166,1185,138,151,140" shape="poly">
                      <area target="" alt="Tribuna_Baja" id="Tribuna_Baja" title="Tribuna_Baja" href="Tribuna_Baja.php" onMouseOver="placeImage3()" onmouseleave="saleraton()"  coords="26,250,91,248,634,241,639,205,695,200,697,239,1263,246,1288,246,1301,205,1209,196,928,194,734,192,518,192,317,196,123,196,2,202" shape="poly">
                  </map>
                          </div>
