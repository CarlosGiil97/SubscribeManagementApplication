  ...
  if(b.id=='Sector2_tribuna_alta'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR2_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR2_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR2_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR2_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR4_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"  id="'+arrayJSidSECTOR4_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR4_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR4_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR6_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR6_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR6_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR6_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR7_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR7_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR7_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR7_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR8_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR8_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR8_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR8_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR9_tribuna_alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"  id="'+arrayJSidSECTOR9_tribuna_alta[$i]+'_'+arrayJSfilasSECTOR9_tribuna_alta[$i]+'_'+arrayJSasientosSECTOR9_tribuna_alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
