 ...
 if(b.id=='Sector2_Fondo_norte_Alto'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR3_FONDO_norte_ALTO[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR3_FONDO_norte_ALTO[$i]+'_'+arrayJSfilasSECTOR3_FONDO_norte_ALTO[$i]+'_'+arrayJSasientosSECTOR3_FONDO_norte_ALTO[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
        document.getElementById('parent').innerHTML+='<div  id="'+arrayJSfilasSECTOR3_FONDO_norte_ALTO[$i]+'_'+arrayJSasientosSECTOR3_FONDO_norte_ALTO[$i]+'" style="border:1px solid black;width:50px;height:35px;background-color:red;cursor: pointer;text-align:center;" disabled="true">'+arrayJSfilasSECTOR3_FONDO_norte_ALTO[$i]+'_'+arrayJSasientosSECTOR3_FONDO_norte_ALTO[$i]+'</div>';
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR5_FONDO_norte_ALTO[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR5_FONDO_norte_ALTO[$i]+'_'+arrayJSfilasSECTOR5_FONDO_norte_ALTO[$i]+'_'+arrayJSasientosSECTOR5_FONDO_norte_ALTO[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR6_FONDO_norte_ALTO[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR6_FONDO_norte_ALTO[$i]+'_'+arrayJSfilasSECTOR6_FONDO_norte_ALTO[$i]+'_'+arrayJSasientosSECTOR6_FONDO_norte_ALTO[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
