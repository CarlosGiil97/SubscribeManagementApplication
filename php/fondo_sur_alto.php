...
<script>
  ...
  if(b.id=='Sector1_Fondo_Sur_Alto'){
    ...
    document.getElementById('titulo').innerHTML='Sector1 Fondo Sur Alto';
 ...
 if(b.id=='Sector2_Fondo_Sur_Alto'){
    document.getElementById('mapa').style.display='none';
    document.getElementById('titulo').innerHTML='Sector2 Fondo Sur Alto';
    ...
    document.getElementById('mapa').style.display='none';
    document.getElementById('titulo').innerHTML='Sector3 Fondo Sur Alto';
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR3_FONDO_SUR_ALTO[$i]== 'Libre'){
        ...
        document.getElementById('parent').innerHTML+='<div  id="'+arrayJSfilasSECTOR3_FONDO_SUR_ALTO[$i]+'_'+arrayJSasientosSECTOR3_FONDO_SUR_ALTO[$i]+'" style="cursor: pointer;text-align:center;" disabled="true"><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" width=50px height=50px src="../images/ocupado.png"></div>';
