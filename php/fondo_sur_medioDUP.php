...
<?php
      ...
      $ocupacionSECTOR1_Fondo_Sur_Medio=[];
         $sql="SELECT id,fila,asiento,estado FROM fondo_sur_medio WHERE sector = 'Sector1_Fondo_Sur_Medio'";
          foreach ($miDB->query($sql) as $filaSECTOR1_Fondo_Sur_Medio) {
            ...
            array_push($ocupacionSECTOR1_Fondo_Sur_Medio, $filaSECTOR1_Fondo_Sur_Medio['estado']);
         }
...
<script>
  ...
  if(b.id=='Sector1_Fondo_Sur_Medio'){
   ...
   console.log(arrayJSidSECTOR1_Fondo_Sur_Medio[0]);
   console.log(arrayJSidSECTOR1_Fondo_Sur_Medio[1]);
   console.log(arrayJSidSECTOR1_Fondo_Sur_Medio[4]);
    // alert(arrayJSidSECTOR1_Fondo_Sur_Medio);
    // alert(arrayJSidSECTOR1_Fondo_Sur_Medio[0]);
    // alert(arrayJSidSECTOR1_Fondo_Sur_Medio[1]);
    ...
    for($i=0;$i<160;$i++){
      if(arrayJSidSECTOR1_Fondo_Sur_Medio[$i] == $i){
        document.getElementById('parent').innerHTML+='<div id ="'+$i+'" onclick="prueba(this)" onmouseleave="salediv(this)" onmousemove="entradiv(this)"  style="border:1px solid black;width:50px;height:35px;background-color:green;text-align:center;" >LIBRE</div>';
      }else{
        document.getElementById('parent').innerHTML+='<div id ="'+$i+'" onclick="prueba(this)" onmouseleave="salediv(this)" onmousemove="entradiv(this)"  style="border:1px solid black;width:50px;height:35px;background-color:red;text-align:center;" >OCUPADO</div>';
  ...
  function prueba(x){
    // document.getElementById(x.id).style.background = "white";
    // document.getElementById(x.id).style.border = "3px solid black";
    document.getElementById(x.id).src="../images/ocupado_mouse.png"
