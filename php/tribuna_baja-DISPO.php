  ...
  if(b.id=='Sector2_tribuna_baja'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR2_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR2_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR2_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR2_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR3_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"  id="'+arrayJSidSECTOR3_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR3_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR3_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR4_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR4_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR4_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR4_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR5_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR5_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR5_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR5_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR11_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"  id="'+arrayJSidSECTOR11_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR11_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR11_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR12_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR12_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR12_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR12_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR13_tribuna_baja[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR13_tribuna_baja[$i]+'_'+arrayJSfilasSECTOR13_tribuna_baja[$i]+'_'+arrayJSasientosSECTOR13_tribuna_baja[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
