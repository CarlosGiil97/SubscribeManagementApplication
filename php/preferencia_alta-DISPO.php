 ...
 if(b.id=='Sector2_Preferencia_Alta'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR2_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR2_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR2_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR2_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR4_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR4_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR4_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR4_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR5_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR5_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR5_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR5_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR7_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR7_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR7_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR7_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR8_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR8_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR8_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR8_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR9_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR9_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR9_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR9_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR10_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent1').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR10_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR10_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR10_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR11_Preferencia_Alta[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)"   id="'+arrayJSidSECTOR11_Preferencia_Alta[$i]+'_'+arrayJSfilasSECTOR11_Preferencia_Alta[$i]+'_'+arrayJSasientosSECTOR11_Preferencia_Alta[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
