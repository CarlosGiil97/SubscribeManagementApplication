 ...
 if(b.id=='Sector2_Preferencia_Media'){
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR2_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR2_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR2_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR2_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR3_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR3_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR3_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR3_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR4_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR4_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR4_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR4_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR5_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR5_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR5_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR5_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR6_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR6_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR6_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR6_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR7_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR7_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR7_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR7_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR8_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR8_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR8_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR8_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR10_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR10_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR10_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR10_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
    ...
    for($i=0;$i<numerodeasientostotales;$i++){
      if(arrayJSocupacionSECTOR11_Preferencia_Media[$i]== 'Libre'){
        document.getElementById('parent').innerHTML+='<div  style=";width:50px;height:35px;text-align:center;" ><img onmouseleave="salediv(this)" onmouseover="entradiv(this)" onclick="prueba(this)"  id="'+arrayJSidSECTOR11_Preferencia_Media[$i]+'_'+arrayJSfilasSECTOR11_Preferencia_Media[$i]+'_'+arrayJSasientosSECTOR11_Preferencia_Media[$i]+'" width=50px height=50px src="../images/libre.png" ></div>';
      }else{
